'''
model.py
Based on https://github.com/r9y9/wavenet_vocoder/blob/master/wavenet_vocoder/wavenet.py
'''

import base.base_model as b
import math
import numpy as np
import torch
...
if config.use_wavenet:
    class MultiSpeakerTTSModel(b.MultiSpeakerTTSModel):
...
class AttentionSeq2Seq(b.AttentionSeq2Seq):
    pass


class Encoder(b.Encoder):
    pass


class AttentionLayer(b.AttentionLayer):
    pass


class Decoder(b.Decoder):
    pass
...
class WaveNet(nn.Module):
    ...
    def __init__(self, in_channels=513, out_channels=30, layers=20, stacks=2,
...
if config.use_wavenet:
    class Converter(WaveNet):
        pass
else:
    class Converter(b.Converter):
        pass
